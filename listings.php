...
<!-- list of listings -->
<?php
	$pageposts = get_pages_with_listings('','highprice', 'allsales');
?>
...
<div id="page-content-inner">
	...
	<div class="listing-item prop-box">
	...
	<?php if (get_listing_totsf()) $line2 .= "<li class='totsf'>" .get_listing_totsf(). " Sq/Ft Total</li>"; ?>
	<?php if (get_listing_acres()) $line2 .= "<li class='acres'>" .get_listing_acres()." Acres</li>"; ?>
